...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
# // want all corners to be equal to the position at least once --
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not collision:
                ...
                newState = (newPosition, newCorners)
...
def foodHeuristic(state, problem):
    ...
    #if theres no food, the exit with0 food
    if not foodGrid.asList():
        return 0

    return min(util.manhattanDistance(position, food) for food in foodGrid.asList())
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        # pathToClosestDot = search.depthFirstSearch(problem)
        # pathToClosestDot = search.uniformCostSearch(problem)
        pathToClosestDot = search.breadthFirstSearch(problem)
